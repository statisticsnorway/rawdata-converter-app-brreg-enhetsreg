...
public class Application extends RawdataConverterApplication {
    ...
    public static void main(String[] args) {
        log.info("rawdata-converter-app-brreg-enhetsreg version: {}", MavenArtifactUtil.findArtifactVersion("no.ssb.rawdata.converter.app", "rawdata-converter-app-brreg-enhetsreg").orElse("unknown"));
